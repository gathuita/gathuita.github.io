    ...
    <div class="wrapper">
        ...
        <form action="" method="POST"enctype="multipart/form-data" >
            <table class="tbl-30">
                <tr>
                    <td>Title:</td>
                    <td>
                        <input type="text" name="tittle"placeholder="Enter food title">
                    </td>
                </tr>
                <tr>
                    <td>Description:</td>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                //check whether the select image is selected or not and upload image if clicked
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        $image_name = "Food_Name_".rand(000,999).'.'.$ext;//e.g Food_Name_001.jpg
                ...
                //create sql to save food into db
